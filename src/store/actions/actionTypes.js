...
export const CREATE_JOB_APP_REQUEST = 'CREATE_JOB_APP_REQUEST';
export const CREATE_JOB_APP_SUCCESS = 'CREATE_JOB_APP_SUCCESS';
export const CREATE_JOB_APP_FAIL = 'CREATE_JOB_APP_FAIL';
